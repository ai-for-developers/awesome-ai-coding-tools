...
- **[OpenCode Goal Mode](https://github.com/devinoldenburg/opencode-goal-mode)** – OpenCode plugin that mechanically enforces goal mode: review gates that block a premature "Goal Completed" until the required reviews pass, stale-on-edit approval invalidation, and a quote-aware shell-tokenizer guard against destructive commands.
