...
- **[Loki Mode](https://github.com/asklokesh/loki-mode)** - Autonomous spec-to-product CLI coding agent with a verification gate that will not mark work done until a blind-review completion council and an evidence check pass; brownfield loki heal, local-first BYO-keys, 26-tool MCP server.
