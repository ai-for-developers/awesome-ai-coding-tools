...
- **[Grinta](https://github.com/josephsenior/Grinta-Coding-Agent)** – Local-first, provider-agnostic Python terminal coding agent with MCP client support, durable checkpoints, recovery scaffolding, LSP/DAP integration, and validation-gated completion.
