...
- **[VibeKit](https://vibekit.bot)** – Phone-first AI app builder: every app gets its own persistent agent that builds, hosts, and keeps improving it over time, with a git repo and live domain. Drive it from native iOS, Telegram, or CLI. BYOK (Anthropic/OpenAI, no markup) or pay-as-you-go.
