...
- **[Kodus](https://kodus.io)** - Open source AI code review without vendor lock-in. Bring any LLM and pay the provider directly with zero markup, or self-host the entire review pipeline.
