...
- **[IssueReady](https://github.com/whyiug/issueready)** – Local-first readiness gate for AI coding workflows that evaluates GitHub issues with traceable evidence without executing agents or writing to GitHub.
