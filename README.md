...
- **[Mythex](https://mythex.ai/?ref=github)** – Chat-to-app builder with live preview, an editable workspace (code, terminal, database), one-click publish, and a remote MCP server for Claude, Cursor and Codex.
