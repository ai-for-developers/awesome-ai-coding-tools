...
- **[SandBase Harness](https://github.com/sandbaseai/sandbase-harness)** – Self-hosted AI agent runtime and local stdio MCP bridge for durable sessions, sandboxed execution, approvals, artifacts, audit, and replay.
