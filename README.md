...
- **[rightmodeler](https://github.com/elm-os/rightmodeler)** – Open-source CLI that replays accepted agent traces against lower-cost candidate models and reports agreement, cost, sample size, and abstentions before teams change a model.
