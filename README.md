...
- **[SandBase CLI](https://github.com/sandbaseai/cli)** – Open-source, agent-first CLI for accessing 2,000+ AI models, multimodal generation, cloud sandboxes, and MCP workflows with one API key.
