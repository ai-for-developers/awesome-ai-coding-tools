...
- **[EasyClaw](https://easyclaw.com/)** - Open‑source AI browser automation framework for automating repetitive web workflows and agent tasks using natural language, featuring low‑code workflow configuration, multi‑site task scheduling, and native LLM agent integration.
