...
- **[Conclave AI](https://conclave-ai.dev)** – A council of three models (Claude, GPT-5, Gemini) reviews each PR and, with a PRD attached, flags scope drift a diff-only review misses. Self-hostable (FSL).
