...
- **[DvalinCode](https://github.com/arthurpanhku/dvalincode)** – Local-first, provider-neutral AI coding agent with three modes (Chat / Cowork / Code), inline diff approval, and a built-in Web GUI. Works with any OpenAI-compatible endpoint — DeepSeek, OpenAI, Claude via OpenRouter, Groq, Ollama. Single-binary release for macOS / Windows / Linux. MIT.
