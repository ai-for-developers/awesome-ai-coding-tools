...
- **[SandBase CLI](https://github.com/sandbaseai/cli)** – Open-source agent-first CLI and MCP bridge that lets developers route coding workflows across 2,000+ AI models and APIs.
