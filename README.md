...
- **[AI Skill Hub](https://github.com/carmenmooo/ai-skill-hub)** – Open-source monorepo of SKILL.md format AI skills for Claude Code, Cursor, Codex, Gemini CLI, Cline, and Trae. Includes Figma Restore for pixel-perfect design-to-code conversion.
