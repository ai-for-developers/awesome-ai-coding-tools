...
- **[Agent Teams](https://github.com/777genius/agent-teams-ai)** – Free open-source desktop app for autonomous coding agent teams across Claude, Codex, and OpenCode. Give high-level commands while agents handle Kanban tasks, messaging, code review, logs, and approvals with 200+ models and 75+ LLM providers.
