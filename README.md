...
- **[SkillsIndex](https://skillsindex.dev)** - Directory of 11,000+ AI agent tools (MCP servers, Claude skills, GPT actions, IDE plugins), each scored 0-100 for security, utility, and maintenance.
