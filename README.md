...
- **[claudestat](https://github.com/DeibyGS/claudestat)** – Real-time token monitoring and cost analytics for Claude Code. Live
  dashboard, quota guard with kill switch, loop detection, and per-session cost breakdown. Open-source, local SQLite, zero cloud.
