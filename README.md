...
- **[Mimir](https://github.com/erayendes/mimir)** – macOS menu bar app that shows real-time usage quotas and reset countdowns for Claude Code, Codex, and Antigravity. Free and open source, no backend.
