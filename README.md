...
- **[mdflow](https://github.com/yubinbin32-ops/Mdflow-Canvas)** – Open-source project memory for AI coding that maps architecture on a Canvas and gives MCP-compatible agents verified, task-scoped context, plans, and checkpoint evidence.
