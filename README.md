...
- **[SandBase CLI](https://github.com/sandbaseai/cli)** – Local MCP bridge CLI that connects Claude Desktop, Cursor, Codex, Claude Code, and other AI coding clients to 2,000+ AI models and API tools, with client-specific configuration and discovery.
