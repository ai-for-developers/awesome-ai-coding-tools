...
- **[Waveloom](https://github.com/Menfre01/waveloom)** – Go terminal-native coding agent with Bubble Tea TUI, DeepSeek V4 prompt caching, and Claude Code-compatible UX.
