...
- **[Agent Island](https://github.com/tristan666666/agent-island)** – Native macOS notch companion for Claude/Codex coding sessions that shows live run state and can auto-resume a selected long-running task after the limit window resets.
