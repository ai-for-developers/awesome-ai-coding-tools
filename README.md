...
- **[DevPilot](https://github.com/geastham/devpilot)** – Planning cockpit for a fleet of coding agents; parallelisation-aware wave planner, computed critical paths, and a "runway" metric for how long until the ready-to-dispatch queue empties. Dispatches Linear issues to Claude Code sessions on machines you own. Open source (MIT).
