...
- **[Ariadne Loop](https://github.com/zhangzeyu99-web/ariadne-loop)** – Verifiable loop-engineering workbench for Codex, Claude Code, OpenClaw, and AI coding agents, producing loop specs, gates, JSON reports, and handoff packets.
