...
- **[ctxpack](https://github.com/trongtruong110-ux/ctxpack)** – Packs a repo into an LLM-ready context bundle with per-model token budgeting (Claude, GPT, Gemini) and automatic secret redaction. Zero-dependency CLI.
