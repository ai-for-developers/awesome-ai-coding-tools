...
- **[SandBase CLI](https://github.com/sandbaseai/cli)** – Open-source CLI that connects Claude Code, Codex, Cursor, Windsurf, and other MCP clients to 2,000+ AI models and APIs without managing provider API keys. Free account available.
