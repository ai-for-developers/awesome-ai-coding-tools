...
- **[SAGE](https://github.com/PsYcGoD/sage)** – Local-first CLI and MCP wrapper for AI coding agents that records command history locally and returns compressed terminal output.
