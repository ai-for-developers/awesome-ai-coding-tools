...
- **[GenCode](https://github.com/yanmxa/gencode)**: Open-source AI coding assistant for the terminal with multi-provider support, flexible context management, and Claude Code extension compatibility.
