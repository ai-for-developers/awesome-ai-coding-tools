...
- **[Neurolink](https://github.com/juspay/neurolink)**: Universal AI development platform that unifies 12+ AI providers (OpenAI, Anthropic, Google, Bedrock, Azure) with built-in MCP support, multi-provider failover, and production-ready enterprise features. TypeScript SDK + CLI.
