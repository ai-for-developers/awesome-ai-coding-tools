...
- **[Wiggum CLI](https://wiggum.app)**: Plug-and-play AI agent that scans any codebase, generates feature specs through AI-powered interviews, and runs autonomous coding loops (the Ralph loop) via Claude Code or any CLI-based agent.
