...
- [agnix](https://github.com/avifenesh/agnix) – Linter for AI agent configurations. Validates CLAUDE.md, Cursor rules, Copilot instructions, MCP configs, and more with 156 rules and auto-fix.
